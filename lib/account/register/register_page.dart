                                ...
                                Padding(
                                    ...
                                    child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Form(
                                            key: _formKey,
                                            autovalidate: _registerController
                                                .autoValidate,
                                            child: _buildInputs(),
                                          ),
                                          SizedBox(height: 20),
  ...
  _buildTitleAndLogo() {
    return Padding(
        ...
        child: Column(children: <Widget>[
          ...
          Text(AppLocalization.registerStart,
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                        ...
                        style: TextStyle(color: Colors.white),
                        onChanged: (value) =>
                            _registerController.model.userName = value,
                    ...
                    TextFormField(
                      ...
                      onTap: () async {
                        ...
                        _dateBirth.text =
                            await _registerController.datePicker(context);
                      },
                    ),
                    SizedBox(height: 10),
                    Text(
        ...
        children: <Widget>[
          Observer(
              builder: (_) => Expanded(
                  ...
                  child: Theme(
                      data: ThemeData(
                          unselectedWidgetColor: ThisMusicColors.white),
                      child: RadioListTile(
                          selected: true,
                          value: UserGender.Male,
                          groupValue: _registerController.selectedGender,
                          title: Text(AppLocalization.male,
                              style: TextStyle(
                                  color: ThisMusicColors.white, fontSize: 10)),
              ...
              builder: (_) => Expanded(
                  ...
                  child: Theme(
                      data: ThemeData(
                          unselectedWidgetColor: ThisMusicColors.white),
                      child: RadioListTile(
                          onChanged: (newValue) => _registerController
                              .setSelectedGenderType(newValue),
                          value: UserGender.Female,
                          groupValue: _registerController.selectedGender,
                          title: Text(AppLocalization.female,
                              style: TextStyle(
                                  color: ThisMusicColors.white, fontSize: 11)),
                          activeColor: Colors.blue)))),
          Observer(
              builder: (_) => Expanded(
                  flex: 1,
                  child: Theme(
                      ...
                      child: RadioListTile(
                          ...
                          groupValue: _registerController.selectedGender,
                          title: Text(AppLocalization.other,
                              style: TextStyle(
                                  color: ThisMusicColors.white, fontSize: 10)),
                          activeColor: Colors.blue,
                          onChanged: (newValue) {
